-- Restaura pregunta de convivencia social sobre quehaceres del hogar (46 preguntas).
...
('convivencia_social',8,5,'¿Cumple de forma equilibrada con las responsabilidades o quehaceres del hogar?'),
